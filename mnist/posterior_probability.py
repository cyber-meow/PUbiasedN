...
valid_data = train_data[idxs][u_num:]
valid_labels = train_labels[idxs][u_num:]
train_data = train_data[idxs][:u_num]
train_labels = train_labels[idxs][:u_num]
